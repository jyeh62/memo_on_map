    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (itemId) {
            ...
            case MENU_REVERSE_GEO: {
                MapPoint mapPoint = MapPoint.mapPointWithGeoCoord(37.5112561, 127.0979883);
                mReverseGeoCoder = new MapReverseGeoCoder(MapApiConst.DAUM_MAPS_ANDROID_APP_API_KEY, /*mMapView.getMapCenterPoint()*/mapPoint, LocationDemoActivity.this, LocationDemoActivity.this);
